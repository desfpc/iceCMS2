...
(
    ...
    `language`           enum ('en', 'ru', 'ge', 'rs')                    not null comment 'User language',
    `languages`          json                                             null comment 'User known languages',
    ...
    `email_approve_code` varchar(24)                                      null comment 'Code to approve E-mail',
    `email_approved`     smallint unsigned                default 0       not null comment 'Email approved status',
    `email_send_time`    timestamp                                        null comment 'Email approve code send time',
    `phone_approve_code` varchar(24)                                      null comment 'Code to approve phone',
    `phone_approved`     smallint unsigned                default 0       not null comment 'Phone approved status',
    `phone_send_time`    timestamp                                        null comment 'User created time',
    `created_time`       timestamp                        default CURRENT_TIMESTAMP not null comment 'User created time',
